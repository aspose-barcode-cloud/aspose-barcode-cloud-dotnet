...
{
    // Coverage for the symbology-specific parameter groups accepted by the Generate API
    // (QR, Code128, Pdf417, MicroQR, RectMicroQR). Split out of GenerateTests to keep the
    // basic endpoint/transport tests separate from typed-parameter-model coverage.
    [TestFixture]
    public class GenerateParametersTests : TestsBase
    {
