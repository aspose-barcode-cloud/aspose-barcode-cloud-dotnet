...
namespace Aspose.BarCode.Cloud.Sdk.Interfaces
{
    ...
    public interface IGenerateApi
    {
        ...
        /// <returns>
        ///     A task representing the asynchronous operation. The result is a <see cref="byte[]" />.
        /// </returns>
        Task<byte[]> BarcodeGenerateBarcodeTypeGetAsync(BarcodeGenerateBarcodeTypeGetRequest request);
        ...
        ///     A task representing the asynchronous operation. The result is a <see cref="byte[]" />.
        /// </returns>
        Task<byte[]> BarcodeGenerateBodyPostAsync(BarcodeGenerateBodyPostRequest request);
        ...
        ///     A task representing the asynchronous operation. The result is a <see cref="byte[]" />.
        /// </returns>
        Task<byte[]> BarcodeGenerateFormPostAsync(BarcodeGenerateFormPostRequest request);
    }
}
